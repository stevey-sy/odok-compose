...
dependencies {
    ...
    // Supabase 모듈들 - 직접 버전 명시
    implementation("io.github.jan-tennert.supabase:postgrest-kt:3.2.2")
    implementation("io.github.jan-tennert.supabase:auth-kt:3.2.2") // gotrue-kt에서 auth-kt로 변경됨
    implementation("io.github.jan-tennert.supabase:realtime-kt:3.2.2")
    implementation("io.github.jan-tennert.supabase:storage-kt:3.2.2") // 파일 업로드가 필요한 경우
