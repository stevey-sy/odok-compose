...
data class AladinBookItem(
    ...
    @Json(name = "pricesales") val pricesales: Int = 0,
    @Json(name = "pricestandard") val pricestandard: Int =0,
    @Json(name = "mallType") val mallType: String,
    @Json(name = "stockstatus") val stockstatus: String?,
    @Json(name = "mileage") val mileage: Int=0,
    @Json(name = "cover") val cover: String,
    @Json(name = "publisher") val publisher: String,
    @Json(name = "salesPoint") val salesPoint: Int=0,
